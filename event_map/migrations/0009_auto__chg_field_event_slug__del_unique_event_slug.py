...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('event_map_event', ['slug'])


        # Changing field 'Event.slug'
        db.alter_column('event_map_event', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=('date_created__month',), max_length=50, populate_from='title'))

    def backwards(self, orm):

        # Changing field 'Event.slug'
        db.alter_column('event_map_event', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
        # Adding unique constraint on 'Event', fields ['slug']
        db.create_unique('event_map_event', ['slug'])
    ...
    models = {
        ...
        'event_map.event': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': "('date_created__month',)", 'max_length': '50', 'populate_from': "'title'"}),
