...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Subscription.public'
        db.delete_column('event_map_subscription', 'public')


    def backwards(self, orm):
        # Adding field 'Subscription.public'
        db.add_column('event_map_subscription', 'public',
