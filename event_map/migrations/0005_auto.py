...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('event_map_event_group', (
        ...
        db.create_unique('event_map_event_group', ['event_id', 'abstractgroup_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('event_map_event_group')
    ...
    models = {
        ...
        'event_map.event': {
            ...
            'group': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['event_map.AbstractGroup']", 'symmetrical': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
