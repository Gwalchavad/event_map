...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('event_map_event', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from='title', unique_with=()))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.slug'
        db.alter_column('event_map_event', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=('date_created__month',), populate_from='title'))
