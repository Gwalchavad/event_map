...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feed.desciption'
        db.alter_column('feed_import_feed', 'desciption', self.gf('django.db.models.fields.TextField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Feed.desciption'
        db.alter_column('feed_import_feed', 'desciption', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'feed_import.feed': {
            ...
            'desciption': ('django.db.models.fields.TextField', [], {'max_length': '255', 'blank': 'True'}),
