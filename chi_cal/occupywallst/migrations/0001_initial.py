...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('occupywallst_listmember', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mlist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='members', to=orm['occupywallst.List'])),
        ...
        db.create_table('occupywallst_userinfo', (
            ...
            ('is_shadow_banned', self.gf('django.db.models.fields.BooleanField')(default=False)),
